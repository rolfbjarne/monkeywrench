    ...
    <div>
        <asp:Table runat="server">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>Revisions after this one won't get scheduled. Leave blank to include all (future) revisions. Git: If you want to track a branch other than the 'remotes/origin/master', set the revision to the remote branch you want to track. Set to 'None' to disable automatic scheduling.</asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
